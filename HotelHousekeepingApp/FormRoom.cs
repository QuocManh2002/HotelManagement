...
namespace HotelHousekeepingApp
{
    public partial class FormRoom : Form
    {
        ...
        {
            Room room = GetRoomObject();
            frmRoomServiceDetail frmRoomService = new frmRoomServiceDetail
            {
                InsertOrUpdate=true,
                selectedRoomNumber = room.RoomNumber,
                Text = "Add a new service"
            };
            if(frmRoomService.ShowDialog() == DialogResult.OK)
            {
                MessageBox.Show("Add a new service successfully", "Task Management", MessageBoxButtons.OK);
            }
        }
